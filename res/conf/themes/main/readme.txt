PEAZIP THEMES
PeaZip 10+ version accepts as icon sources arbitrarily sized graphic saved as 32 bit or 8 bit PNG with transparency.
...
MAIN THEME
Main theme provides icons meant for a "neutral" look and feel, in order to be visually familiar to users of different operating systems such as macOS, Windows, and various Linux and BSD desktop environments.
